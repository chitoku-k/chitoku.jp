...
[^2]: [サービス詳細 | v6プラス | So-net (ソネット)](https://www.so-net.ne.jp/access/hikari/v6plus/detail.html#anc-4)
[^3]: [v6プラス(IPv6/IPv4インターネットサービス) | 日本ネットワークイネイブラー株式会社](https://www.jpne.co.jp/service/v6plus/#v6pbbr)
